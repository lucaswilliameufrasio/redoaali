...
<div class="container">
    <h3 class="cadastroprodutotitulo">Atualização de dados do Produto</h3>
    <div>
    ...
    <form method="POST" action="{{ route('produto.editarproduto', $produto->id) }}">
        {{ csrf_field() }}
        {!! method_field('PATCH')!!}
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="name_product" type="text" class="form-control{{ $errors->has('name_product') ? ' é inválido' : '' }}" name="name_product" value="{{ $produto->name_product}}"" required autofocus>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="amount" type="number" class="form-control{{ $errors->has('amount') ? ' é inválido' : '' }}" name="amount" value="{{ $produto->amount}}" required autofocus>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="datadisponivel" type="date" class="form-control{{ $errors->has('datadisponivel') ? ' é inválido' : '' }}" name="datadisponivel" value="{{ $produto->datadisponivel}}" required autofocus>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="horarioinicial" type="time" class="form-control{{ $errors->has('horarioinicial') ? ' é inválido' : '' }}" name="horarioinicial" value="{{ $produto->horarioinicial}}" required autofocus>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="horarioinicial" type="time" class="form-control{{ $errors->has('horariofinal') ? ' é inválido' : '' }}" name="horariofinal" value="{{ $produto->horariofinal}}" required autofocus>
